...
applyKeymaps(require("config.keymaps.diagnostic"))
...
applyKeymaps(require("config.keymaps.hunk"))
applyKeymaps(require("config.keymaps.textobjects"))
applyKeymaps(require("config.keymaps.telescope"))
applyKeymaps(require("config.keymaps.live-server"))
